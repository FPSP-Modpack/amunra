...
public class EntityShuttle extends EntityTieredRocket {
    ...
    public EntityShuttle(World par1World, double par2, double par4, double par6, boolean reversed, int rocketType,
        ItemStack[] inv) {
    ...
    protected void spawnParticles(boolean launched) {
        if (!this.isDead) {
            ...
            Vector3 mv1 = motionVec.clone()
                .translate(d1);
            Vector3 mv2 = motionVec.clone()
                .translate(d2);
            Vector3 mv3 = motionVec.clone()
                .translate(d3);
            Vector3 mv4 = motionVec.clone()
                .translate(d4);
    ...
    protected void checkStandingPosition() {
        ...
        if (this.getLandingPad() != null) {
            ...
            Vector3int highest = WorldHelper
