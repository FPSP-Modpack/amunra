...
public class AIFollowClosest extends EntityAIBase {
    ...
    public AIFollowClosest(EntityLiving user, Class<? extends Entity> classToFollow, float maxDistance, float minDistance)
    {
    ...
    public AIFollowClosest(EntityLiving user, Class<? extends Entity> classToFollow, float maxDistance, float minDistance, float probability)
    {
        this.theWatcher = user;
        this.watchedClass = classToFollow;
        this.maxDistanceForPlayer = maxDistance;
