...
public class PacketSimpleAR extends Packet implements IPacket {
    ...
    public void handleClientSide(EntityPlayer player) {
        ...
        switch (this.type) {
            ...
            case C_UPDATE_MOTHERSHIP_LIST:
                ...
                if (FMLClientHandler.instance()
                    .getClient().currentScreen instanceof GuiShuttleSelection) {
                    ((GuiShuttleSelection) FMLClientHandler.instance()
                        .getClient().currentScreen).mothershipListUpdated();
                }
            ...
            case C_NEW_MOTHERSHIP_CREATED:
                ...
                if (FMLClientHandler.instance()
                    .getClient().currentScreen instanceof GuiARCelestialSelection) {
                    ((GuiARCelestialSelection) FMLClientHandler.instance()
                        .getClient().currentScreen).newMothershipCreated(motherShip);
                }
            ...
            case C_MOTHERSHIP_CREATION_FAILED:
                if (FMLClientHandler.instance()
                    .getClient().currentScreen instanceof GuiARCelestialSelection) {
                    ((GuiARCelestialSelection) FMLClientHandler.instance()
                        .getClient().currentScreen).mothershipCreationFailed();
                }
                break;
            case C_MOTHERSHIP_TRANSIT_STARTED:// (Side.CLIENT, Integer.class, String.class, Long.class),
                ...
                if (FMLClientHandler.instance()
                    .getClient().currentScreen instanceof GuiShuttleSelection) {
                    ((GuiShuttleSelection) FMLClientHandler.instance()
                        .getClient().currentScreen).mothershipPositionChanged(motherShip);
                }
                break;
            ...
            case C_MOTHERSHIP_DATA:
                ...
                if (playerWorldProvider.dimensionId == dimId
                    ...
                    if (FMLClientHandler.instance()
                        .getClient().currentScreen instanceof GuiMothershipSelection) {

                        ((GuiMothershipSelection) FMLClientHandler.instance()
                            .getClient().currentScreen).mothershipUpdateRecieved();
                    }
                }
                break;
            case C_ADD_MOTHERSHIP_PLAYER_FAILED:
                if (FMLClientHandler.instance()
                    .getClient().currentScreen instanceof GuiMothershipSettings) {
                    String msg = (String) this.data.get(0);
                    String name = (String) this.data.get(1);
                    ((GuiMothershipSettings) FMLClientHandler.instance()
                        .getClient().currentScreen)
            ...
            case C_MOTHERSHIP_SETTINGS_CHANGED:
                ...
                if (player.worldObj.provider.dimensionId == mShip.getDimensionID() && FMLClientHandler.instance()
                    .getClient().currentScreen instanceof GuiMothershipSettings) {
                    ((GuiMothershipSettings) FMLClientHandler.instance()
                        .getClient().currentScreen).mothershipResponsePacketRecieved();
                }
                break;
            case C_TELEPORT_SHUTTLE_PERMISSION_ERROR:
                if (FMLClientHandler.instance()
                    ...
                    ((GuiShuttleSelection) FMLClientHandler.instance()
                        .getClient().currentScreen).showMessageBox(
    ...
    public void handleServerSide(EntityPlayer player) {
        ...
        switch (this.type) {
            ...
            case S_MOTHERSHIP_TRANSIT_START: // (Side.SERVER, Integer.class, String.class),
                ...
                if (provider != null && provider.startTransit(targetBody, false)) {
                    ...
                    AmunRa.packetPipeline.sendToDimension(
                        new PacketSimpleAR(PacketSimpleAR.EnumSimplePacket.C_MOTHERSHIP_TRANSIT_FAILED, mothershipId),
            ...
            case S_MOTHERSHIP_UPDATE:
                ...
                int dimId = (Integer) this.data.get(0);
                mcServer = FMLCommonHandler.instance()
    ...
    public void processPacket(INetHandler var1) {
         ...
         * EnumSimplePacket.C_UPDATE_PLANETS_LIST && this.type != EnumSimplePacket.C_UPDATE_CONFIGS)
         * {
         * return;
         * }
         */
