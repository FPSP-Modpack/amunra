...
public class ShuttleTeleportHelper {
        ...
        if (playerStats.launchpadStack != null && playerStats.launchpadStack.stackSize > 0
            ...
            if (shuttle.rocketType.getInventorySpace() <= 2) {
                ...
                if (!player.inventory.addItemStackToInventory(playerStats.launchpadStack)) {
                     ...
                     * itemDropPosition.z, playerStats.launchpadStack);
    ...
    public static HashMap<String, Integer> getArrayOfPossibleDimensions(EntityPlayerMP playerBase) {
        ...
        if (playerBody == null) {
             ...
             * final SpaceStationWorldData data = SpaceStationWorldData.getStationData(playerBase.worldObj,
             * playerBase.dimension, null);
             * map.put(playerBody.getName() + "$" + data.getOwner() + "$" + data.getSpaceStationName() + "$" +
             * playerBase.dimension + "$" + data.getHomePlanet(), playerBase.dimension);
             * // TEMP!
