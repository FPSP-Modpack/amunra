...
public class AstronomyHelper {
     ...
     * for a planet and it's moon the planet, for two planets in the same solar system or two moons of different
     * planetes
    ...
    public static CelestialBody getClosestCommonParent(CelestialBody body1, CelestialBody body2) {
        ...
        if (body1 instanceof Planet && !(body2 instanceof Planet)) {
            ...
            return getClosestCommonParent(
                ((Planet) body1).getParentSolarSystem()
                    .getMainStar(),
                body2);
            ...
            return getClosestCommonParent(
                body1,
                ((Planet) body2).getParentSolarSystem()
                    .getMainStar());
