...
public class EntityFXMothershipIonFlame extends EntityFX {
    ...
    public void onUpdate() {
        ...
        if (this.particleAge++ >= this.particleMaxAge) {
             ...
             * GalacticraftCore.proxy.spawnParticle(this.spawnSmokeShort ? "whiteSmokeLargeLaunched" :
             * "whiteSmokeLargeIdle", new Vector3(this.posX, this.posY + this.rand.nextDouble() * 2, this.posZ), new
             * Vector3(this.motionX, this.motionY, this.motionZ), new Object[] {});
             * if (!this.spawnSmokeShort)
             * {
             * GalacticraftCore.proxy.spawnParticle("whiteSmokeIdle", new Vector3(this.posX, this.posY +
