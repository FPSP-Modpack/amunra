...
abstract public class AbstractPermissionTab extends AbstractTab
    ...
    public AbstractPermissionTab(TileEntityMothershipSettings tile, GuiMothershipSettings parent, Minecraft mc,
        ...
        permissionModeMap
            .put(Mothership.PermissionMode.ALL, GCCoreUtil.translate("tile.mothershipSettings.permission.allowAll"));
        permissionModeMap
            .put(Mothership.PermissionMode.NONE, GCCoreUtil.translate("tile.mothershipSettings.permission.allowNone"));
