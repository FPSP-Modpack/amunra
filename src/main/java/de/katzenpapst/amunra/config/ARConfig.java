...
public class ARConfig {
    ...
    public void processConfig(Configuration config) {
        ...
        dimNeper = config.get("dimension_ids", "Neper", dimNeper)
            .getInt();
        dimMaahes = config.get("dimension_ids", "Maahes", dimMaahes)
            .getInt();
        dimAnubis = config.get("dimension_ids", "Anubis", dimAnubis)
            .getInt();
        dimHorus = config.get("dimension_ids", "Horus", dimHorus)
            .getInt();
        dimSeth = config.get("dimension_ids", "Seth", dimSeth)
            .getInt();
        dimMehen = config.get("dimension_ids", "Mehen", dimMehen)
            .getInt();
        ...
        // general
        planetDefaultTier = config
            .getInt("default_tier", "general", planetDefaultTier, 0, 1000, "Default tier for AmunRa planets and moons");
