...
public class ClientProxy extends ARSidedProxy {
    ...
    public static void registerEntityRenderers() {
        ...
        ClientRegistry.bindTileEntitySpecialRenderer(
            ...
            new RenderMothershipJet(engineModel, new ResourceLocation(AmunRa.ASSETPREFIX, "textures/model/jet.png")));
        ClientRegistry.bindTileEntitySpecialRenderer(
        ...
        ClientRegistry.bindTileEntitySpecialRenderer(
            ...
            new RenderMothershipBooster(new ResourceLocation(AmunRa.ASSETPREFIX, "textures/blocks/jet-base-ion.png")));
