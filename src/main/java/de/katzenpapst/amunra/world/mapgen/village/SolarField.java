            ...
            for (int z = startZ; z < stopZ; z++) {
                ...
                if (x == startX + 2 || x == stopX - 3) {
                    if (z == startZ + 2) {
                         ...
                         * this.rotateStandardMetadata(0, this.coordMode))) {
                         * this.parent.addPopulator(new TouchSolarPanel(getXWithOffset(x, z), groundLevel,
                         * getZWithOffset(x, z)));
                         * }
                         */
                        ...
                        /*
                         * if(placeBlockRel2BB(blocks, metas, chunkX, chunkZ, x, groundLevel, z, GCBlocks.solarPanel,
                         * this.rotateStandardMetadata(1, this.coordMode))) {
                         * this.parent.addPopulator(new TouchSolarPanel(getXWithOffset(x, z), groundLevel,
                         * getZWithOffset(x, z)));
                         * }
                         */
