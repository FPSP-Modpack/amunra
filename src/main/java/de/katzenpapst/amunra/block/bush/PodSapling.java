            ...
            for (int curX = (int) -outerRadius; curX <= +outerRadius; curX++) {
                for (int curZ = (int) -outerRadius; curZ <= +outerRadius; curZ++) {
                    ...
                    if (Math.pow(curX / outerRadius, 2) + Math.pow((curY - centerOffset) / heightHalf, 2)
                        ...
                        if (curY > -1
                            && Math.pow(curX / innerRadius, 2) + Math.pow((curY - centerOffset) / innerHeightRadius, 2)
                         ...
                         * curZ+z))
                         * {
                         * this.setBlockAndNotifyAdequately(world, curX+x, curY+y, curZ+z, this.wood.getBlock(),
                         * this.wood.getMetadata(), notify);
                         * }
                         */
