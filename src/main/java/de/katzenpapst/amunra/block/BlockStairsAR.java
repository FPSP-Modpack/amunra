...
public class BlockStairsAR extends BlockStairs implements IMassiveBlock {
    ...
    public String getUnlocalizedName() {
        ...
        if (mBlock != null) {
            return "tile." + mBlock.getSubBlock(sourceBlock.getMetadata())
                .getUnlocalizedName() + ".stairs";
        }
        return "tile." + this.sourceBlock.getBlock()
            .getUnlocalizedName() + ".stairs";
    }
    ...
    public void register() {
        ...
        this.setHarvestLevel(
            sourceBlock.getBlock()
                .getHarvestTool(sourceBlock.getMetadata()),
            sourceBlock.getBlock()
                .getHarvestLevel(sourceBlock.getMetadata()));
    ...
    public IIcon getIcon(int side, int meta) {
        return this.sourceBlock.getBlock()
            .getIcon(side, this.sourceBlock.getMetadata());
    }
    ...
    public void onEntityWalking(World world, int x, int y, int z, Entity ent) {
        this.getSourceBlock()
            .onEntityWalking(world, x, y, z, ent);
    }
    ...
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float xOffset,
        ...
        return this.getSourceBlock()
            .onBlockActivated(world, x, y, z, player, 0, 0.0F, 0.0F, 0.0F);
    }
    ...
    public void onBlockDestroyedByExplosion(World world, int x, int y, int z, Explosion kaboom) {
        this.getSourceBlock()
            .onBlockDestroyedByExplosion(world, x, y, z, kaboom);
    }

    @Override
    public MapColor getMapColor(int foo) {
        return this.sourceBlock.getBlock()
            .getMapColor(sourceBlock.getMetadata());
    }
}
