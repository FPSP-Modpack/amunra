...
public class ARBlocks {
    ...
    public static void initBlocks() {
        ...
        metaBlockBasaltOre.setMultiblockHarvestLevel(1)
            .setHardness(2.0F)
            .setResistance(10.0F);
        ...
        metaBlockObsidianOre.setMultiblockHarvestLevel(3)
            .setHardness(50.0F)
        ...
        metaBlockHardClayOre.setMultiblockHarvestLevel(1)
            .setHardness(1.25F)
            .setResistance(30.0F);
        ...
        metaBlockConcreteOre.setMultiblockHarvestLevel(3)
            .setHardness(3.0F)
            .setResistance(30.0F);
         ...
         * soundTypeGlass);
         * //blockRegistry.addObject(174, "packed_ice", (new
        ...
        blockBasalt = metaBlockRock.addSubBlock(
            1,
            new SubBlockRock("basalt", "amunra:basalt", "pickaxe", 1, 2.0F, 10.0F).setBlockToDrop(blockBasaltCobble));
        ...
        blockRedRock = metaBlockRock.addSubBlock(
            3,
            new SubBlockRock("redrock", "amunra:redrock", "pickaxe", 1, 2.0F, 10.0F).setBlockToDrop(blockRedCobble));
        ...
        blockMethaneLog = metaBlockLog
            .addSubBlock(0, new SubBlockWood("methanewood", "amunra:log_methane", "amunra:log_methane_top", "axe", 1));
        ...
        blockPodSapling = metaBlockSapling.addSubBlock(
            1,
            new PodSapling("podSapling", "amunra:lumipod_sapling").setWood(blockPodBark)
                .setLeaves(blockPodLeaf));
