...
public class ARItems {
    ...
    protected static void initOreDrops() {
        // dark matter
        ((SubBlockDropItem) (ARBlocks.getSubBlock(ARBlocks.blockDarkmatter))).setDroppedItem(darkShard)
            .setXpDrop(5, 9)
            .setMinDropRate(2)
            .setIsValueable(true);

        // cryo stuff
        ARBlocks.subCryo.setDroppedItem(coldCrystal)
            .setXpDrop(2, 4);

        // diamond
        ARBlocks.subDiamond.setSmeltItem(Items.diamond, 1)
            .setDroppedItem(Items.diamond)
            .setXpDrop(3, 7);

        // ruby
        ARBlocks.subRuby.setSmeltItem(rubyGem.getItemStack(1))
            .setDroppedItem(rubyGem)
            .setXpDrop(3, 7);

        // coal
        ARBlocks.subCoal.setSmeltItem(Items.coal, 1)
            .setDroppedItem(Items.coal)
            .setXpDrop(3, 7);

        // emerald
        ARBlocks.subEmerald.setSmeltItem(Items.emerald, 1)
            .setDroppedItem(Items.emerald)
            .setXpDrop(3, 7);

        // lithium
        ARBlocks.subLithium.setDroppedItem(lithiumGem)
            .setXpDrop(3, 7);

        // lapis
        ARBlocks.subLapis.setDroppedItem(new ItemDamagePair(Items.dye, 4))
            .setMinDropRate(4)
            .setXpDrop(2, 5);
        ...
        ARBlocks.subSteel.setSmeltItem(steelIngot.getItemStack(1))
