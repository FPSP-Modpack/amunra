...
public class ModelRobotVillager extends ModelVillager {
    ...
    public ModelRobotVillager(float scaleOrSo, float par2, int textureX, int textureY) {
        ...
        this.villagerNose.setTextureOffset(24, 0)
            .addBox(-1.0F, -1.0F, -1.0F, 2, 4, 2, scaleOrSo + 0.002F);
    ...
    private ModelRenderer generateArm(float scaleOrSo, float par2, int textureX, int textureY, boolean mirror) {
        ...
        arm.setTextureOffset(40, 38)
            .addBox(-1.5F, 0.0F, -1.5F, 3, 9, 3, scaleOrSo + 0.004F);
        ...
        clawFrontUpper.setTextureOffset(40, 50)
            .addBox(-0.5F, 0.5F, -0.5F, 1, 2, 1, scaleOrSo + 0.004F);
        ...
        clawBackUpper.setTextureOffset(40, 50)
            .addBox(-0.5F, 0.5F, -0.5F, 1, 2, 1, scaleOrSo + 0.004F);
        ...
        clawFrontLower.setTextureOffset(40, 50)
            .addBox(-0.5F, 0.5F, -0.5F, 1, 2, 1, scaleOrSo + 0.004F);
        ...
        clawBackLower.setTextureOffset(40, 50)
            .addBox(-0.5F, 0.5F, -0.5F, 1, 2, 1, scaleOrSo + 0.004F);
