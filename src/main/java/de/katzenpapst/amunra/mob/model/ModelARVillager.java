...
public class ModelARVillager extends ModelVillager {
    ...
    public ModelARVillager(float scaleOrSo, float par2, int textureX, int textureY) {
        ...
        this.villagerHead.setTextureOffset(0, 0)
            .addBox(-4.0F, -10.0F, -4.0F, 8, 10, 8, scaleOrSo + 0.001F);
        ...
        this.villagerNose.setTextureOffset(24, 0)
            .addBox(-1.0F, -1.0F, -6.0F, 2, 4, 2, scaleOrSo + 0.002F);
        ...
        this.villagerBody.setTextureOffset(16, 20)
            .addBox(-4.0F, 0.0F, -3.0F, 8, 12, 6, scaleOrSo + 0.003F);
        this.villagerBody.setTextureOffset(0, 38)
            .addBox(-4.0F, 0.0F, -3.0F, 8, 18, 6, scaleOrSo + 0.5F + 0.004F);
        ...
        this.villagerArms.setTextureOffset(44, 22)
            .addBox(-8.0F, -2.0F, -2.0F, 4, 8, 4, scaleOrSo + 0.005F);
        this.villagerArms.setTextureOffset(44, 22)
            .addBox(4.0F, -2.0F, -2.0F, 4, 8, 4, scaleOrSo + 0.0001F);
        this.villagerArms.setTextureOffset(40, 38)
            .addBox(-4.0F, 2.0F, -2.0F, 8, 4, 4, scaleOrSo + 0.0004F);
        ...
        antenna1.setTextureOffset(54, 6)
            .addBox(4.0F, -0.5F, -0.5F, 4, 1, 1, scaleOrSo + 0.5F);
        ...
        antennaTip1.setTextureOffset(56, 8)
            .addBox(0.0F, -1.5F, -1.5F, 1, 3, 3, scaleOrSo + 0.5F);
        ...
        antenna2.setTextureOffset(54, 6)
            .addBox(4.0F, -0.5F, -0.5F, 4, 1, 1, scaleOrSo + 0.5F);
        ...
        antennaTip2.setTextureOffset(56, 8)
            .addBox(0.0F, -1.5F, -1.5F, 1, 3, 3, scaleOrSo + 0.5F);
